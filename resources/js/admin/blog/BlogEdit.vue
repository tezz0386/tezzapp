                ...
                <div class="card-body" style="display: none">
                  ...
                  <div class="form-group">
                    ...
                    <textarea
                      ...
                      class="form-control"
                      rows="3"
                      v-model="this.blog.meta_description"
                    ></textarea>
                  </div>
                </div>
              </div>
...
export default {
  ...
  created() {
    ...
    this.$axios.get("/snactum/csrf-cookie").then((response) => {
      this.$axios
        .get(window.Laravel.base_url + "admin/blog/" + this.$route.params.id)
        .then((response) => {
          console.log(response.data.message);
          this.blog = response.data.blog;
          this.$Progress.finish();
          this.showPreview = true;
          this.imagePreview = "/uploads/blogs/thumbnail/" + this.blog.image;
        })
        .catch((error) => {
          console.log(error);
        })
    ...
    */
    ...
    updateBlog() {
      ...
      this.$axios.get("/sanctum/csrf-cookie").then((response) => {
        this.$axios
          .post(
            window.Laravel.base_url + "admin/blog/" + this.blog.id,
            formData
          )
          .then((response) => {
            this.blog = response.data.blog;
